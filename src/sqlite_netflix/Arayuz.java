...
public class Arayuz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sqlite_netflix/OturumAc.JPG"))); // NOI18N
        ...
        jButton1.setBounds(1770, 40, 140, 50);

        Giris.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sqlite_netflix/netflix.png"))); // NOI18N
        getContentPane().add(Giris);
        Giris.setBounds(0, 0, 1920, 1060);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        /*JLabel oturum_ac = new JLabel("Oturum Ac");
        jButton1.setHorizontalTextPosition(SwingConstants.CENTER);
        jButton1.add(oturum_ac);
        oturum_ac.setVisible(true);
        */
